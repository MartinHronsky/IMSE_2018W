...
public class SchedulePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		return this.idCourse.equals(castOther.idCourse) && this.idLocation.equals(castOther.idLocation)
				&& this.dateFrom.equals(castOther.dateFrom) && this.dateTo.equals(castOther.dateTo);
	}
