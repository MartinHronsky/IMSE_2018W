...
public class CourseGenerator {
	...
	private String[] lan = { "English", "German", "French", "Dutch", "Chinese", "Japan", "Russian", "Slovak", "Spanish",
	...
	private String[] note = { "Discount for large groups or students", "Still free places available",
			"Group full. If enough applicant register, second class will be opened",
			"Bonus: 5 conversation classes for free." };
	...
	public void generateCourse() {
		...
		name = language.substring(0, 3) + "_" + cr_type.substring(0, 3) + rand.nextInt(Integer.MAX_VALUE);
		notes = vat;
